...
let geomURL =
  "https://docs.google.com/spreadsheets/d/e/2PACX-1vRAGqjKPKIprC74iL7drtcVVylrROIw8AwHUJkfqlON58WIEuUHlzaBnhLPiGxVkxVD7O5EbiKnYzWw/pub?output=csv";
let pointsURL =
  "https://docs.google.com/spreadsheets/d/e/2PACX-1vTSMzohIJEmufTuYou3MTVqP_-C6f-9zUz7AZXeAczHyUQ0RNJNprSDSjw-H8hKAX2gGc3JQKLJMc-e/pub?output=csv";
...
function init() {
  ...
  map = L.map("map").setView([35.51, 24.01], 14);
